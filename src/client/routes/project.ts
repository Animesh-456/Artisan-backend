...
router.post("/after-payment", cn.after_cashfree);
...
router.post("/delete-art", cn.delete_art);
...
router.get("/steps-text", cn.steps_text);
...
router.post("/delete-art-image", cn.delete_art_image);
